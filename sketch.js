...
function setup() {
  ...
  ground3 = new Ground(250,40,width,20);
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(460,230,100,100);
  bunny.addImage(rabbit);
  bunny.scale = 0.2;
  higherground =new Ground(450,300,140,10);
...
function draw() 
{
  ...
  push();
  fill ("black");
  text("'space' to pop bubble",width/5,40);
  pop();
